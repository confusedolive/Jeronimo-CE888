...
path = r'C:\Users\jeron\OneDrive\Desktop\lab10 ce888\code\data\heart.csv'
...
pkl_random = os.path.join(model_dir,'rf_pkl_model.plk')
...
pkl_svc = os.path.join(model_dir,'svc_pkl_model.plk')
